...
const translations = {
	pt: {
		...
		description: "Procurando por um desenvolvedor full-stack que pode arquitetar e implementar soluções completas? Vamos discutir seu projeto.",
	...
	en: {
		...
		description: "Looking for a full-stack developer who can architect and implement complete solutions? Let's discuss your project.",
		location: "São Paulo, SP",
			...
			<div className="max-w-4xl mx-auto text-center">
				<motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="space-y-8">
					...
					<div className="flex justify-center gap-4">
						...
						<a
							href="https://www.linkedin.com/in/luhenrivieira?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
							target="_blank"
							rel="noopener noreferrer"
							className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-lg"
						>
